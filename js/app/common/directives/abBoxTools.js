      ...
      return {
        ...
        link: function($scope, element) {
          ...
          var template = function() {
            ...
            if (
              !angular.isDefined($scope.hideRefresh) ||
              $scope.hideRefresh === "0" ||
            ...
            if (
              !angular.isDefined($scope.hideMaxMin) ||
              $scope.hideMaxMin === "0" ||
              $scope.hideMaxMin === "false"
            ) {
              retVal += toolminmax;
            }
            if (
              !angular.isDefined($scope.hideFullScreen) ||
              $scope.hideFullScreen === "0" ||
              $scope.hideFullScreen === "false"
            ) {
              retVal += toolfullscreen;
            }
            if (
              !angular.isDefined($scope.hideRemove) ||
              $scope.hideRemove === "0" ||
