...
(function () {
    ...
    //Main fuction for the directive
    function slimScroll($document, $window, $compile) {
        ...
        function slimScroll(scope, element, attrs) {
            ...
            scope.scrollContent = function (y, isWheel) {
                releaseScroll = false;
                var delta = y,
                    maxTop = el.offsetHeight - bar[0].offsetHeight, percentScroll;
        ...
        function setScopeValues(scope, element, attrs) {
            ...
            scope.color = attrs['color'] || '#920312';
            scope.position = attrs['position'] || 'right';
            scope.distance = attrs['distance'] || '5px';
