...
(function () {
    "use strict";
    angular.module("abTimelineModule", [[]])
        .controller("AngularTimeline", ["$scope", "$notification", "config",
            function ($scope, $notification, config) {
              ...
              "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";
                ...
                if (config.debug) {
                    $notification.success("Timeline loaded", "AngularJs Timeline", config.notificationDelay);
                }
            }]);
})();
